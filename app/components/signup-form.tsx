    ...
    <form action={""} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                required
              >
                  <option disabled>Please choose the business type</option>
                  <option value="option1" selected>Individual</option>
                  <option value="option2" selected>Company</option>
                  <option value="option3" selected>Others</option>
              </select>
        ...
        <Button className="mt-4 w-full" aria-disabled={isPending}>
          Create my Account <ArrowRightIcon className="ml-auto h-5 w-5 text-gray-50" />
        </Button>
        <div
